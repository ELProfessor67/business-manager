      ...
      <div className="container bg-gray-100 mx-auto flex flex-wrap px-5 py-5 flex-col md:flex-row items-center">
...

        {
          isSignedIn
            ...
            : <Link href="https://expert-raccoon-9.accounts.dev/sign-in" className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Sign In
